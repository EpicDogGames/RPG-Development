...
public class Ent_Wandering : Interactable, IEnemy {
	...
	void Start () {
		...
		DropTable.loot = new List<LootDrop> {
			new LootDrop("healthElixir", 60),
			new LootDrop("manaElixir", 40)
		};
		ID = "ent_wandering";
	...
	void ReturnToOrigin()  {
		...
		// go to that position and when within distanceFromOrigin variable (say 10 units), start wandering again

...
public class Ent_Patrolling : Interactable, IEnemy {
	...
	void Update () {
		...
		if (Vector3.Distance(player.transform.position, this.transform.position) < 10 && (angle < 270 || state == "pursuing"))  {

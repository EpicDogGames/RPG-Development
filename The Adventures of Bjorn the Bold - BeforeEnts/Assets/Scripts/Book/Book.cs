...
public class Book : MonoBehaviour {
    ...
    void Update()
    {
		...
		// modification of code ... BJSG
		//  if user wants to skip the intro entirely, press Enter key to load next scene
		if (Input.GetKeyDown(KeyCode.Return))  {
			SceneManager.LoadScene (loadScene);
		}
		// if user has reached the end of the book, next scene is loaded
